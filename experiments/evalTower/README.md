### Key components we need to mock up a single working trial of causaldraw_annotations
...
4. `js/jspsych-survey-likert.js`: custom plugin that will display: (i) reference tower image, (ii) likert scale
